    ...
    public partial class Mainform : Form
    {
        ...
        private void ProcessInput()
        {
            ...
            if (lower.Contains("my name is"))
            {
                ...
                string greeting = "Nice to meet you, " + name + "! How can I help you stay safe online today?";
                AppendBotMessage(greeting);
                audioHelper.Speak(greeting);
                return;
            }
            ...
            if (lower.Contains("i am interested in") || lower.Contains("i'm interested in"))
            {
                ...
                string interestReply = "Great! I'll remember that you're interested in " + topic +
                    ". It's a crucial part of staying safe online. " +
                    "Feel free to ask me anything about it!";
                AppendBotMessage(interestReply);
                audioHelper.Speak(interestReply);
                return;
            }
